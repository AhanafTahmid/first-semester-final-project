...
int index = 29, i = 0, color[] = {222, 213, 242, 219, 110}, car_color[] = {227, 236, 136, 89, 214, 89, 227}, gap = 2, p1 = 0, p2 = 1;
...
void threat_mover(int i)
{
    ...
    /* if(t[i].threat_type == 1)
    {
        if(i % 2)   C = rash2(t[i].pos);

        else    C = rash1(t[i].pos);
    }

    else    C = linear(t[i].pos); */
...
void multiplay()
{
    ...
    canvas(upper_left, lower_right, 220, 219, 223, 219, 121);
    ...
    while(1)
    {
        go_track(foot_path, around1, 239);

        go_track(road_divider, around2, 239);

        go_track(foot_path, around3, 239);
...
void monoplay()
{
    ...
    canvas(score_board_pos_A, score_board_pos_B, 220, 219, 223, 219, 220);
    ...
    while(1)
    {
        ...
        go_track(foot_path, around2, 239);
...
void mono_game_crash()
{
    ...
    draw_alphabet(smallG, i, j, 210, 5);

    Sleep(100);

    draw_alphabet(smallA, i + 7, j, 210, 5);

    Sleep(100);

    draw_alphabet(smallM, i + 14, j, 210, 5);

    Sleep(100);

    draw_alphabet(smallE, i + 21, j, 210, 5);

    Sleep(100);

    draw_alphabet(smallO, i + 31, j, 210, 5);

    Sleep(100);

    draw_alphabet(smallV, i + 38, j, 210, 5);

    Sleep(100);

    draw_alphabet(smallE, i + 45, j, 210, 5);

    Sleep(100);

    draw_alphabet(smallR, i + 52, j, 210, 5);
...
void multi_game_crash(int f)
{
    ...
    if(f == 1)
    {
        draw_alphabet(smallP, i, j, 210, 5);

        Sleep(100);

        draw_alphabet(smallL, i + 7, j, 210, 5);

        Sleep(100);

        draw_alphabet(smallA, i + 14, j, 210, 5);

        Sleep(100);

        draw_alphabet(smallY, i + 21, j, 210, 5);

        Sleep(100);

        draw_alphabet(smallE, i + 28, j, 210, 5);

        Sleep(100);

        draw_alphabet(smallR, i + 35, j, 210, 5);

        Sleep(100);

        draw_alphabet(small2, i + 42, j, 210, 5);

        Sleep(100);

        draw_alphabet(smallW, i + 53, j, 210, 5);

        Sleep(100);

        draw_alphabet(smallI, i + 60, j, 210, 5);

        Sleep(100);

        draw_alphabet(smallN, i + 67, j, 210, 5);

        Sleep(100);

        draw_alphabet(smallS, i + 74, j, 210, 5);
    ...
    else if(f == 2)
    {
        ...
        draw_alphabet(small1, i + 42, j, 210, 5);
    ...
    else if(f == 3)
    {
        ...
        draw_alphabet(smallM, i, j, 210, 5);
        ...
        draw_alphabet(smallT, i + 14, j, 210, 5);

        Sleep(100);

        draw_alphabet(smallC, i + 21, j, 210, 5);

        Sleep(100);

        draw_alphabet(smallH, i + 28, j, 210, 5);

        Sleep(100);

        draw_alphabet(smallT, i + 38, j, 210, 5);

        Sleep(100);

        draw_alphabet(smallI, i + 45, j, 210, 5);

        Sleep(100);

        draw_alphabet(smallE, i + 52, j, 210, 5);
...
void setup()
{
    ...
    draw_alphabet(R, 55, 5, 211, 10);
    draw_alphabet(E, 65, 5, 244, 10);
    draw_alphabet(T, 75, 5, 65, 10);
    draw_alphabet(R, 85, 5, 214, 10);
    draw_alphabet(O, 95, 5, 85, 10);

    draw_alphabet(R, 50, 17, 116, 10);
    draw_alphabet(U, 60, 17, 214, 10);
    draw_alphabet(M, 70, 17, 211, 10);
    draw_alphabet(B, 80, 17, 85, 10);
    draw_alphabet(L, 90, 17, 65, 10);
    draw_alphabet(E, 100, 17, 211, 10);
...
int your_profile()
{
    ...
    gotoxy(15, 11);
    printf("Best      : %d", highest);

    gotoxy(15, 14);
    printf("Your Best : %d", P[avatar].highest);
