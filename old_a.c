...
//Write Data for products when shopper add
void s_writeData()
{
	int i;
	FILE *fp;
...
//Customer writeData, Enter input of the customer in the txt file
void cc_writeData()
{
    int i;
	FILE *fp;
...
//            {
//
//                return login(1);//shows invalid customer
//            }
            //return 1;
